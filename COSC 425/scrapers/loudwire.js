...
async function scrapeLoudwireNews() {
    ...
    const news = await page.evaluate(() => {
        ...
        articles.forEach(article => results.push({
            ...
            image: article.querySelector('.theframe').getAttribute('style').substring(23, article.querySelector('.theframe').getAttribute('style').length - 3),
        }));
        return results;
    });
    await browser.close();
...
printDemo();
//# sourceMappingURL=loudwire.js.map